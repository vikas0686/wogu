...
import dev.wogu.core.ValidationEngine;
import dev.wogu.core.ValidatorExecutionException;
import dev.wogu.report.HtmlReportGenerator;
...
final class WoguRunner {
  ...
  /**
   * Runs every discoverable {@link dev.wogu.api.WorkflowValidator} against {@code context}
