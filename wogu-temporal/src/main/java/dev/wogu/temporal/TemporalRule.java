 ...
 * {@link dev.wogu.api.WorkflowValidator} is the public extension point other engine
...
interface TemporalRule {
   ...
   * @param contextEntryPoints calls that establish an {@link dev.wogu.temporal.callgraph.ExecutionContext}
